        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTimeOffset(new DateTime(2024, 10, 12, 8, 18, 50, 245, DateTimeKind.Unspecified).AddTicks(5496), new TimeSpan(0, 0, 0, 0, 0))),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_accout_transfers", x => x.id);
                    table.ForeignKey(
                        name: "fk_accout_transfers_accounts_source_account_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_accout_transfers_accounts_target_account_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_accout_transfers_source_account_id",
                schema: "core",
                table: "accout_transfers",
                column: "source_account_id");

            migrationBuilder.CreateIndex(
                name: "ix_accout_transfers_target_account_id",
                schema: "core",
                table: "accout_transfers",
