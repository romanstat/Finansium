...
public interface ISavingsGoalRepository
{
    ...
    Task<SavingsGoal?> GetByIdWithAccountNoTrackingAsync(Ulid id, CancellationToken cancellationToken);
    void Add(SavingsGoal savingsGoal);
    Task<bool> IsNameUniqueAsync(Ulid accountId, string name, CancellationToken cancellationToken);
